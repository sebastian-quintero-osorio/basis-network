...
\begin{tabular}{@{}lrrr@{}}
\toprule
\textbf{Layout} & \textbf{Storage+Logic} & \textbf{Total Est.} & \textbf{$<$300K} \\
\midrule
...
\midrule
\textbf{Total}                 & \textbf{285,756} & \textbf{100.0} \\
\bottomrule
\end{tabular}
\end{table}
...
\toprule
\textbf{Comparison} & \textbf{1st Batch} & \textbf{Steady St.} \\
\midrule
Rich $-$ Minimal (metadata)       & +22,643  & +24,997  \\
Minimal $-$ Events (root hist.)   & +22,269  & +22,269 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{@{}lccc@{}}
\toprule
\textbf{Invariant} & \textbf{A} & \textbf{B} & \textbf{C} \\
\midrule
