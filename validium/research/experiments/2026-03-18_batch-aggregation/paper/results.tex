% results.tex -- Batch Aggregation Paper (RU-V4)
...
\begin{tabular}{rrrr}
\toprule
\textbf{Batch} & \textbf{Throughput} & \textbf{95\% CI} & \textbf{Batch} \\
\textbf{Size}  & \textbf{(tx/min)}   &                   & \textbf{Latency (ms)} \\
\midrule
\multicolumn{4}{l}{\emph{Batch size sweep (200 tx/min)}} \\
4   & 210,324 & [207,426 -- 213,223] & 0.010 \\
8   & 161,795 & [157,584 -- 166,007] & 0.011 \\
16  & 19,178  & [18,854 -- 19,502]   & 0.010 \\
\midrule
\multicolumn{4}{l}{\emph{Arrival rate sweep (threshold 16)}} \\
200 tx/min  & 17,867  & [17,270 -- 18,464] & 0.013 \\
500 tx/min  & 206,656 & [202,306 -- 211,007] & 0.022 \\
1000 tx/min & 274,438 & [268,942 -- 279,934] & 0.015 \\
\bottomrule
\end{tabular}
\end{table}
...
formation latency remains sub-0.025~ms across all configurations, five orders
of magnitude below the 5,000~ms target. All 95\% CI half-widths are within
10\% of the mean.
