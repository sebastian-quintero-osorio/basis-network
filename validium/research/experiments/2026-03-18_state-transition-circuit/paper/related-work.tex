...
\end{tabular}
\par\vspace{1mm}
\parbox{\textwidth}{\footnotesize Per-tx constraints at depth 32. Hermez includes EdDSA signature
...
\end{tabular}
\par\vspace{1mm}
\parbox{\textwidth}{\footnotesize Rapidsnark and Tachyon benchmarks from \cite{tachyon2024}.
