...
\midrule
Orch. overhead       & 593~ms  & push0: 5.2~ms & Expected$^*$ \\
Batch formation only & 11.4~ms & push0: 5.2~ms & 2.2$\times$ (consistent) \\
Memory per component & 85~MB   & push0: 8--14~MB & Expected$^\dagger$ \\
\bottomrule
\end{tabular}
\begin{flushleft}
