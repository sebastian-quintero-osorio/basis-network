// ==========================================================
// Halo2Verifier.sol -- Generated verifier for Basis Network circuit
// Generated by: basis-prover gen-verifier (halo2-solidity-verifier)
// ==========================================================
...
contract Halo2Verifier {
    ...
    uint256 internal constant NUM_INSTANCE_CPTR = 0x0864;
    uint256 internal constant     INSTANCE_CPTR = 0x0884;
    ...
    function verifyProof(
        ...
        assembly {
...

            {
                ...
                extcodecopy(vk, VK_MPTR, 0x00, 0x08a0)
            ...
            // Compute quotient evavluation
            {
                ...
                }
                {
                    ...
                    let var8 := addmod(var7, var1, r)
                    let var9 := mulmod(var6, var8, r)
                    let a_2_prev_1 := calldataload(0x0404)
                    let a_0 := calldataload(0x0384)
                    let var10 := sub(r, a_0)
                ...
                {
                    let perm_z_last := calldataload(0x07a4)
                ...
                }
                {
                    ...
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x03e4), mulmod(beta, calldataload(0x06e4), r), r), gamma, r), r)
                ...
                }
                {
                    ...
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0424), mulmod(beta, calldataload(0x0724), r), r), gamma, r), r)
            ...
            // Compute pairing lhs and rhs
            {
                ...
                }
                {
                    ...
                    let r_eval
                    r_eval := mulmod(coeff, calldataload(0x0664), r)
                ...
                }
                {
                    let zeta := mload(ZETA_MPTR)
                    let r_eval
                    r_eval := addmod(r_eval, mulmod(mload(0xe0), calldataload(0x07a4), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x0100), calldataload(0x07c4), r), r)
                ...
                }
                {
                    ...
                    mstore(0x00, calldataload(0x0204))
                    mstore(0x20, calldataload(0x0224))
                    ...
                    mstore(0x80, calldataload(0x0104))
                    mstore(0xa0, calldataload(0x0124))
                    ...
                    mstore(PAIRING_RHS_X_MPTR, calldataload(0x0824))
                    mstore(PAIRING_RHS_Y_MPTR, calldataload(0x0844))
                }
            }
