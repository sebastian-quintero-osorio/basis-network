...
| S5 | Network dashboard with real-time activity | l1/dashboard | Live |
...
| ID | Feature | Component | Status |
|---|---|---|---|
| C1 | AWM cross-chain communication demo | l1/contracts | Planned |
...
| C5 | Network monitoring dashboard with real-time data | l1/dashboard | Live |
